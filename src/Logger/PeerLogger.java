...
public class PeerLogger {
    ...
    public void tcpConnection(int peerGeneratingLog, int peerConnectedTo){
        ...
        System.out.println(timeStamp+": Peer " + peerGeneratingLog + " makes a connection to Peer " + peerConnectedTo);
    }
    ...
    public void changePreferredNeighbors(int peerID, int[] preferredNeighborList){
        ...
        System.out.println(timeStamp+": Peer " + peerID + " has the preferred neighbors " + Arrays.toString(preferredNeighborList));
    }
    ...
    public void changeOptimisticallyUnchockedNeighbor(int peerID, int optimisticallyUnchokedNeighbor){
        ...
        System.out.println(timeStamp+": Peer " + peerID + " has the optimistically unchoked neighbor " + optimisticallyUnchokedNeighbor);
    }
    ...
    public void unchoking(int peerUnchoked, int peerWhoUnchokes){
        ...
        System.out.println(timeStamp+": Peer " + peerUnchoked + " is unchoked by " + peerWhoUnchokes);
    }

    public void choking(int peerChoked, int peerWhoChokes){
        String timeStamp= getTimeStamp();
        printToFile(timeStamp+": Peer " + peerChoked + " is choked by " + peerWhoChokes);
        System.out.println(timeStamp+": Peer " + peerChoked + " is choked by " + peerWhoChokes);
    }
    ...
    public void receivedHaveMessage(int peerReceivedMessage, int peerSentMessage, int pieceIndex){
        ...
        System.out.println(timeStamp+": Peer " + peerReceivedMessage + " received the ‘have’ message from " + peerSentMessage + " for the piece " + pieceIndex);
    }
    ...
    public void receivedInterestedMessage(int peerReceivedMessage, int peerSentMessage){
        ...
        System.out.println(timeStamp+": Peer " + peerReceivedMessage + " received the ‘interested’ message from " + peerSentMessage);
    }
    ...
    public void receivedNotInterestedMessage(int peerReceivedMessage, int peerSentMessage){
        ...
        System.out.println(timeStamp+": Peer " + peerReceivedMessage + " received the ‘not interested’ message from " + peerSentMessage);
    }
